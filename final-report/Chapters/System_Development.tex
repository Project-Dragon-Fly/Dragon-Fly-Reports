...
CCTV Video surveillance systems utilize restricted closed network isolated from the internet, to reduce Cyber attack vectors and unauthorized usage.  VPN (Virtual Private Network) split tunnel enables secure communication interface to the network over unsecured channels. Wireguard, distributed in Linux Kernel, is utilized for the creation of VPN interface with very less overhead and very high performance.
