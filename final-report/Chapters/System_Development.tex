...
Video stream from NVR and IP camera are ingested to our system by Stream Handler and FrameGen module for proccessing using OpenCV.

Additionaly, FFmpeg is used for over transcode live RSTP stream from IP camera and NVR, 
