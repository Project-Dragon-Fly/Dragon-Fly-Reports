...
This is costly in terms of resource requirements as each camera will have a dedicated AI engine instance, requiring significant amount of computational power. Without MPS (Multi Proccess Service), GPU's required may result in significant expense.
